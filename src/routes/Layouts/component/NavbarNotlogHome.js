...
import {
  ...
  import { RiMenuLine, RiMacbookLine, RiCustomerService2Line } from 'react-icons/ri';
  import {
    RiWalletLine,
  } from 'react-icons/ri';
const NavbarNotlogHome = props => {
    ...
    >
      ...
      <ExtendedDropdown.Section className="nav-ex-drop" style={{padding:"0"}}>
        ...
        <ExtendedDropdown.Section style={{ padding: '0' }}>
          <ListGroup style={{ padding: '0', border: 'none' }}>
            <ListGroupItem tag={'a'} href='/trade/binance/BTCUSDT' className="nav-list-item" action>
              <div>
            ...
            <ListGroupItem tag={'a'} href='/support' className="nav-list-item" action>
              <div>
...
export default NavbarNotlogHome;